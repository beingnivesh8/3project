...
#streamli page
icon='https://icon2.cleanpng.com/20181208/ieb/kisspng-social-media-computer-icons-scalable-vector-graphi-pinterest-social-media-icons-icon-5c0c119d5a1460.447428241544294813369.jpg'
st.set_page_config(page_title='AIRBNB ANALYSIS',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by N.P.Nivesh'})
st.title("🏙️:rainbow[AIRBNB ANALYSIS]🗂️")

with st.sidebar:
    select_option=option_menu("Menu",["About","Map","Insights"])
if select_option=="About":
    st.image( r"C:\Users\N.P.Nivesh\Desktop\Python\Projects\3. Airbnb\shutterstock_1149823916.jpg")
